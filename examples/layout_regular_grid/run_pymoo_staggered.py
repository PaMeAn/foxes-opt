...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-nt", "--n_t", help="The number of turbines", type=int, default=13
    )
    parser.add_argument(
        "-t",
        "--turbine_file",
    ...
    parser.add_argument(
        "-G", "--n_gen", help="The number of generations", type=int, default=15
    )
    parser.add_argument(
    ...
    #     np.array([[0, 0], [0, 2_000], [2_000, 1_600], [2_000, 0]], dtype=np.float64)
    # )
    ...
    with foxes.Engine.new(
        ...
        problem = RegularLayoutOptProblem(
            "layout_opt", algo, min_spacing=args.min_dist, staggered=True
        )
